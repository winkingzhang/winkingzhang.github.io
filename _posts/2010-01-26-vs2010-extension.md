...
![GotoDef extension工程](/images/vs2010/o_Tool_Option_GotoDef_Proj.png)
...
![GoToDef中的配置UI](/images/vs2010/GoToDefOptPage_2.png)

完成以后在VS Extension工程中引用这个`Package` 并添加到VSIX输出中，这样就可以使用配置了：
![配置GoToDef](/images/vs2010/Use_GoToDef_Opt_2.png)
![调用配置](/images/vs2010/Use_GoToDef_Opt2_2.png)

至此，为VS Extension提供自定义配置的工作就完成了，具体效果如下
![GoToDef中的配置](/images/vs2010/o_options.png)
